            ...
            <section className='my-20' id="skills">
                <div className='flex gap-16'>
                    ...
                    <div>
                        ...
                        <h1 className='w-3/4 text-white font-medium text-5xl mb-16'><span className='text-[#939AFF]'>I offer professional MERN development services. </span>With expertise in building robust web applications</h1>
                        <div className='grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-x-6 gap-y-10'>
                            {
